...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in orm.User.objects.all():
            uuids = user.organisations.all().values_list('uuid', flat=True)
            user.organisations2 = orm['organisations.Organisation'].objects.filter(uuid__in=uuids)

    def backwards(self, orm):
        "Write your backwards methods here."
        for user in orm.User.objects.all():
            user.organisations2.clear()
    ...
    models = {
        ...
        u'accounts.user': {
            ...
            'organisations2': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['organisations.Organisation']", 'null': 'True', 'blank': 'True'}),
