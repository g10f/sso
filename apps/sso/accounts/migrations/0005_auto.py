...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field organisations2 on 'User'
        m2m_table_name = db.shorten_name(u'accounts_user_organisations2')
    ...
    def backwards(self, orm):
        # Removing M2M table for field organisations2 on 'User'
        db.delete_table(db.shorten_name(u'accounts_user_organisations2'))
