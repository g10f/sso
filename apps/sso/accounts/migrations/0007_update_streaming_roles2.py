...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            streaming_user_role = orm.ApplicationRole.objects.get(application__uuid=streaming_uuid, role__name='User')

            for user in User.objects.filter(is_active=True).exclude(application_roles=streaming_user_role):
                
                app_roles_dict_array = [{'uuid': streaming_uuid, 'roles': ['User']}]
