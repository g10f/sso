...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.group'
        db.add_column(u'accounts_role', 'group',
        ...
        db.create_unique(u'accounts_role', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Role', fields ['name']
        db.delete_unique(u'accounts_role', ['name'])

        # Deleting field 'Role.group'
        db.delete_column(u'accounts_role', 'group_id')
