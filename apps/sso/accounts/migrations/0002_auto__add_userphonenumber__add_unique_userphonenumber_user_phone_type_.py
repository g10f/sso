...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_useraddress', (
            ...
            ('street_address', self.gf('django.db.models.fields.TextField')(max_length=512)),
        ...
        db.add_column(u'accounts_user', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'User.dob'
        db.add_column(u'accounts_user', 'dob',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.homepage'
        db.add_column(u'accounts_user', 'homepage',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'accounts_user', 'gender')

        # Deleting field 'User.dob'
        db.delete_column(u'accounts_user', 'dob')

        # Deleting field 'User.homepage'
        db.delete_column(u'accounts_user', 'homepage')
    ...
    models = {
        ...
        u'accounts.useraddress': {
            ...
            'street_address': ('django.db.models.fields.TextField', [], {'max_length': '512'}),
