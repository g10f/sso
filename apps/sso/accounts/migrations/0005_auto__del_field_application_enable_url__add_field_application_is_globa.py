...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'accounts_application', 'enable_url', 'global_navigation')
        # Adding field 'Application.is_active'
        db.add_column(u'accounts_application', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        db.rename_column(u'accounts_application', 'global_navigation', 'enable_url')
        # Deleting field 'Application.is_active'
        db.delete_column(u'accounts_application', 'is_active')
