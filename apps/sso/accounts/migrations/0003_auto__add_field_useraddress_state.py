...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAddress.state'
        db.add_column(u'accounts_useraddress', 'state',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['l10n.AdminArea'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAddress.state'
        db.delete_column(u'accounts_useraddress', 'state_id')
