...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field admin_regions on 'User'
        m2m_table_name = db.shorten_name(u'accounts_user_admin_regions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'accounts.user'], null=False)),
            ('adminregion', models.ForeignKey(orm[u'organisations.adminregion'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'adminregion_id'])

        # Adding M2M table for field admin_countries on 'User'
        m2m_table_name = db.shorten_name(u'accounts_user_admin_countries')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'accounts.user'], null=False)),
            ('country', models.ForeignKey(orm[u'l10n.country'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'country_id'])


    def backwards(self, orm):
        # Removing M2M table for field admin_regions on 'User'
        db.delete_table(db.shorten_name(u'accounts_user_admin_regions'))

        # Removing M2M table for field admin_countries on 'User'
        db.delete_table(db.shorten_name(u'accounts_user_admin_countries'))
