...
urlpatterns = [
    ...
    path('password_resend/done/', TemplateView.as_view(template_name="accounts/password_resend_done.html"),
    ...
    path('organisation_change/<int:pk>/', organisation.OrganisationChangeDetailView.as_view(),
