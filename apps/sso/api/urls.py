...
urlpatterns = [
    ...
    url(r'^v1/users/(?P<uuid>[a-z0-9]{32})/apps/$', users.UserDetailView.as_view(is_apps_only=True),
        name='v1_users_apps'),
    ...
    url(r'^v2/users/(?P<uuid>[a-z0-9]{32})/navigation/$', users_v2.GlobalNavigationView.as_view(),
        name='v2_navigation'),
    url(r'^v2/organisations/$', organisations.OrganisationList.as_view(), name='v2_organisations'),
    url(r'^v2/organisations/(?P<uuid>[a-z0-9]{32})/$', organisations.OrganisationDetailView.as_view(),
    ...
    url(r'^v2/country_groups/(?P<uuid>[a-z0-9]{32})/$', country_groups.CountryGroupDetailView.as_view(),
        name='v2_country_group'),
    url(r'^v2/associations/$', associations.AssociationList.as_view(), name='v2_associations'),
    url(r'^v2/associations/(?P<uuid>[a-z0-9]{32})/$', associations.AssociationDetailView.as_view(),
        name='v2_association'),
