...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'emails_email', 'name')

        # Adding field 'GroupEmail.name'
        db.add_column(u'emails_groupemail', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'GroupEmail.is_guide_email'
        db.add_column(u'emails_groupemail', 'is_guide_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GroupEmail.is_active'
        db.add_column(u'emails_groupemail', 'is_active',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'emails_email', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'GroupEmail.name'
        db.delete_column(u'emails_groupemail', 'name')

        # Deleting field 'GroupEmail.is_guide_email'
        db.delete_column(u'emails_groupemail', 'is_guide_email')

        # Deleting field 'GroupEmail.is_active'
        db.delete_column(u'emails_groupemail', 'is_active')
    ...
    models = {
        ...
        u'emails.groupemail': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_guide_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
