...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupEmail'
        db.create_table(u'emails_groupemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emails.Email'], unique=True)),
        ))
        db.send_create_signal(u'emails', ['GroupEmail'])

        # Adding field 'Email.is_active'
        db.add_column(u'emails_email', 'is_active',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GroupEmail'
        db.delete_table(u'emails_groupemail')

        # Deleting field 'Email.is_active'
        db.delete_column(u'emails_email', 'is_active')
    ...
    models = {
        ...
        u'emails.groupemailadmin': {
            'Meta': {'unique_together': "(('group_email', 'user'),)", 'object_name': 'GroupEmailAdmin'},
