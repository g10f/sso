...
urlpatterns = [
    ...
    url(r'^chained_filter/(?P<app>organisations)/(?P<model>OrganisationCountry)/(?P<field>[\w\-]+)/(?P<value>[\w\-]+)/$', filterchain, kwargs={'manager': 'active_objects'}, name='chained_filter'),
