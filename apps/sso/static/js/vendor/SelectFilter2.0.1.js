...
(function($) {
    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            // button type="button" class="btn btn-link" title="Choose"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span></button>
            ...
            var arrow_right = quickElement('span', add_link)
            arrow_right.className = 'glyphicon';
            ...
            var arrow_left = quickElement('span', remove_link)
            arrow_left.className = 'glyphicon';
