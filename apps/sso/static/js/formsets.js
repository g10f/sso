...
(function ($) {
    $(function () {
        /*
         * initialize the stackedFormsets
         */
        $('[data-formset-type="stacked"]').each(function () {
            var formset_prefix = $(this).data('formset-prefix');
            $("#" + formset_prefix + "-group .inline-related").stackedFormset({
                prefix: formset_prefix,
                staticPrefix: $(this).data('static-prefix'),
                deleteText: $(this).data('delete-text'),
                addText: $(this).data('add-text')
            });
        });
        /*
         * initialize the tabularFormsets
         */
    ...
    $.fn.formset = function (opts) {
        ...
        if ($this.length && showAddButton) {
            ...
            var addHtml = '<a href="javascript:void(0)"><i class="bi bi-plus-circle"></i> ' + options.addText + '</a>';
            ...
            addButton.click(function (e) {
                ...
                var deleteHtml = '<a class="' + options.deleteCssClass + '" href="javascript:void(0)"><i class="bi bi-dash-circle"></i> ' + options.deleteText + '</a>';
                if (row.is("tr")) {
