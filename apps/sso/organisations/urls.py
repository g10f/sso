...
urlpatterns = [
    ...
    url(r'^export.csv$', views.OrganisationList.as_view(export=True, filename="organisations.csv",
                                                        content_type='text/csv;charset=utf-8;'),
        name='organisation_list_csv'),
    url(r'^export.txt$', views.OrganisationList.as_view(export=True, content_type='text;charset=utf-8;'),
        name='organisation_list_txt'),
    ...
    url(r'^(?P<uuid>[a-z0-9]{32})/picture/$', views.OrganisationPictureUpdateView.as_view(),
        name='organisation_picture_update'),
    ...
    url(r'^country/(?P<uuid>[a-z0-9]{32})/$', country.OrganisationCountryDetailView.as_view(),
        name='organisationcountry_detail'),
    url(r'^country/(?P<uuid>[a-z0-9]{32})/update/$', country.OrganisationCountryUpdateView.as_view(),
        name='organisationcountry_update'),
