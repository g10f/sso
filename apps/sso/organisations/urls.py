...
urlpatterns = [
    ...
    path('<sso.uuid:uuid>/', views.OrganisationDetailView.as_view(), name='organisation_detail'),
    path('<sso.uuid:uuid>/update/', views.OrganisationUpdateView.as_view(), name='organisation_update'),
    path('<sso.uuid:uuid>/delete/', views.OrganisationDeleteView.as_view(), name='organisation_delete'),
    path('<sso.uuid:uuid>/picture/', views.OrganisationPictureUpdateView.as_view(), name='organisation_picture_update'),
    ...
    path('region/<sso.uuid:uuid>/', region.AdminRegionDetailView.as_view(), name='adminregion_detail'),
    path('region/<sso.uuid:uuid>/update/', region.AdminRegionUpdateView.as_view(), name='adminregion_update'),
    ...
    path('country/<sso.uuid:uuid>/', country.OrganisationCountryDetailView.as_view(), name='organisationcountry_detail'),
    path('country/<sso.uuid:uuid>/update/', country.OrganisationCountryUpdateView.as_view(), name='organisationcountry_update'),
