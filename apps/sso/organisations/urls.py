...
urlpatterns = [
    ...
    path('export.txt', views.OrganisationList.as_view(export=True, content_type='text;charset=utf-8;'),
    ...
    path('<uuid:uuid>/picture/', views.OrganisationPictureUpdateView.as_view(),
         name='organisation_picture_update'),
    path('add/', views.OrganisationCreateView.as_view(), name='organisation_create'),
    path('region/', region.AdminRegionList.as_view(), name='adminregion_list'),
    ...
    path('country/<uuid:uuid>/', country.OrganisationCountryDetailView.as_view(),
         name='organisationcountry_detail'),
    path('country/<uuid:uuid>/update/', country.OrganisationCountryUpdateView.as_view(),
