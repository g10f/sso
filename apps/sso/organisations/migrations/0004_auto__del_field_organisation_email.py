...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'organisations_organisation', 'email')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Organisation.email'
        raise RuntimeError("Cannot reverse this migration. 'Organisation.email' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Organisation.email'
        db.add_column(u'organisations_organisation', 'email',
