...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganisationCountry.is_active'
        db.add_column(u'organisations_organisationcountry', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AdminRegion.is_active'
        db.add_column(u'organisations_adminregion', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganisationCountry.is_active'
        db.delete_column(u'organisations_organisationcountry', 'is_active')

        # Deleting field 'AdminRegion.is_active'
        db.delete_column(u'organisations_adminregion', 'is_active')
