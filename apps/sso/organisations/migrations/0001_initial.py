    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('homepage', models.URLField(verbose_name='homepage', blank=True)),
                ('email', models.OneToOneField(null=True, blank=True, to='emails.Email', verbose_name='email address', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_region', smart_selects.db_fields.ChainedForeignKey(verbose_name='admin region', blank=True, to='organisations.AdminRegion', null=True, on_delete=models.CASCADE)),
                ('country', models.ForeignKey(verbose_name='country', to='l10n.Country', null=True, on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(verbose_name='country', to='l10n.Country', on_delete=models.CASCADE)),
                ('organisation', models.ForeignKey(to='organisations.Organisation', on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.OneToOneField(null=True, verbose_name='country', to='l10n.Country', on_delete=models.CASCADE)),
