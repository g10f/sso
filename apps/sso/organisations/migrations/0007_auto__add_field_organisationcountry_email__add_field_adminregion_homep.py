...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganisationCountry.email'
        db.add_column(u'organisations_organisationcountry', 'email',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emails.Email'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'AdminRegion.homepage'
        db.add_column(u'organisations_adminregion', 'homepage',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'AdminRegion.email'
        db.add_column(u'organisations_adminregion', 'email',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['emails.Email'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganisationCountry.email'
        db.delete_column(u'organisations_organisationcountry', 'email_id')

        # Deleting field 'AdminRegion.homepage'
        db.delete_column(u'organisations_adminregion', 'homepage')

        # Deleting field 'AdminRegion.email'
        db.delete_column(u'organisations_adminregion', 'email_id')
