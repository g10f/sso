...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganisationCountry'
        db.create_table(u'organisations_organisationcountry', (
            ...
            ('country', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['l10n.Country'], unique=True, null=True)),
            ('homepage', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'organisations', ['OrganisationCountry'])


    def backwards(self, orm):
        # Deleting model 'OrganisationCountry'
        db.delete_table(u'organisations_organisationcountry')
