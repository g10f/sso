...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.can_publish'
        db.add_column(u'organisations_organisation', 'can_publish',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organisation.can_publish'
        db.delete_column(u'organisations_organisation', 'can_publish')
