...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdminRegion.country'
        db.alter_column(u'organisations_adminregion', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['l10n.Country']))

        # Changing field 'Organisation.admin_region'
        db.alter_column(u'organisations_organisation', 'admin_region_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['organisations.AdminRegion'], null=True))

    def backwards(self, orm):

        # Changing field 'AdminRegion.country'
        db.alter_column(u'organisations_adminregion', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['l10n.Country'], null=True))

        # Changing field 'Organisation.admin_region'
        db.alter_column(u'organisations_organisation', 'admin_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisations.AdminRegion'], null=True))
    ...
    models = {
        ...
        u'organisations.adminregion': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['l10n.Country']", 'blank': 'True'}),
