...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'registration_registrationprofile', 'purpose', 'about_me')
        db.alter_column(u'registration_registrationprofile', 'about_me', self.gf('django.db.models.fields.TextField')(max_length=1024))

        db.rename_column(u'registration_registrationprofile', 'known_person1', 'known_person1_first_name')
        db.rename_column(u'registration_registrationprofile', 'known_person2', 'known_person2_first_name')

        # Adding field 'RegistrationProfile.known_person1_last_name'
        db.add_column(u'registration_registrationprofile', 'known_person1_last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'RegistrationProfile.known_person2_last_name'
        db.add_column(u'registration_registrationprofile', 'known_person2_last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'RegistrationProfile.check_back'
        db.add_column(u'registration_registrationprofile', 'check_back',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RegistrationProfile.is_access_denied'
        db.add_column(u'registration_registrationprofile', 'is_access_denied',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'RegistrationProfile.notes'
        db.delete_column(u'registration_registrationprofile', 'notes')

    def backwards(self, orm):
        db.rename_column(u'registration_registrationprofile', 'about_me', 'purpose')
        db.alter_column(u'registration_registrationprofile', 'purpose', self.gf('django.db.models.fields.TextField')(max_length=512))

        db.rename_column(u'registration_registrationprofile', 'known_person1_first_name', 'known_person1')
        db.rename_column(u'registration_registrationprofile', 'known_person2_first_name', 'known_person2')

        # Deleting field 'RegistrationProfile.known_person1_last_name'
        db.delete_column(u'registration_registrationprofile', 'known_person1_last_name')

        # Deleting field 'RegistrationProfile.known_person2_last_name'
        db.delete_column(u'registration_registrationprofile', 'known_person2_last_name')

        # Deleting field 'RegistrationProfile.check_back'
        db.delete_column(u'registration_registrationprofile', 'check_back')

        # Deleting field 'RegistrationProfile.is_access_denied'
        db.delete_column(u'registration_registrationprofile', 'is_access_denied')

        # Adding field 'RegistrationProfile.notes'
        db.add_column(u'registration_registrationprofile', 'notes',
