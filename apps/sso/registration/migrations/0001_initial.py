    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_validated', models.BooleanField(default=False, help_text='Designates whether this profile was already validated by the user.', verbose_name='validated')),
                ...
                ('is_access_denied', models.BooleanField(default=False, help_text='Designates if access is denied to the user.', verbose_name='access denied')),
                ('last_modified_by_user', current_user.models.CurrentUserField(related_name=b'registrationprofile_last_modified_by', verbose_name='last modified by', to=settings.AUTH_USER_MODEL, null=True)),
                ('user', models.OneToOneField(verbose_name='user', to=settings.AUTH_USER_MODEL)),
                ('verified_by_user', models.ForeignKey(related_name=b'registrationprofile_verified_by', verbose_name='verified by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
