...
class OAuth2BaseTestCase(TestCase):
    fixtures = ['initial_data.json', 'test_l10n_data.xml', 'test_organisation_data.json', 'app_roles.json', 'test_app_roles.json', 'test_user_data.json', 'test_oauth2_data.json']
