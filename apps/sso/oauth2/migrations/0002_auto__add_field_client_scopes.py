...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.scopes'
        db.add_column(u'oauth2_client', 'scopes',
                      self.gf('django.db.models.fields.CharField')(default='openid profile email', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.scopes'
        db.delete_column(u'oauth2_client', 'scopes')
    ...
    models = {
        ...
        u'oauth2.client': {
            ...
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "u'vfYcXLbhIu1q'", 'max_length': '2047', 'blank': 'True'}),
            ...
            'scopes': ('django.db.models.fields.CharField', [], {'default': "'openid profile email'", 'max_length': '512'}),
